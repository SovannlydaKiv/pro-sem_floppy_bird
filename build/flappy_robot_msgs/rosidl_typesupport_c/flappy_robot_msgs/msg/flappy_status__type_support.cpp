...
static const _FlappyStatus_type_support_symbol_names_t _FlappyStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flappy_robot_msgs, msg, FlappyStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flappy_robot_msgs, msg, FlappyStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flappy_robot_msgs, msg, FlappyStatus)() {
  return &::flappy_robot_msgs::msg::rosidl_typesupport_c::FlappyStatus_message_type_support_handle;
}
